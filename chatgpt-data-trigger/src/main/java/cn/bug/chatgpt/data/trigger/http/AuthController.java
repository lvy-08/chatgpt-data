...
import cn.bug.chatgpt.data.domain.auth.model.entity.AuthStateEntity;
import cn.bug.chatgpt.data.domain.auth.model.valobj.AuthTypeVO;
import cn.bug.chatgpt.data.domain.auth.service.IAuthService;
import cn.bug.chatgpt.data.domain.weixin.model.entity.MessageTextEntity;
import cn.bug.chatgpt.data.domain.weixin.model.entity.UserBehaviorMessageEntity;
import cn.bug.chatgpt.data.domain.weixin.model.valobj.MsgTypeVO;
import cn.bug.chatgpt.data.domain.weixin.service.IWeiXinBehaviorService;
import cn.bug.chatgpt.data.types.common.Constants;
import cn.bug.chatgpt.data.types.model.Response;
import cn.bug.chatgpt.data.types.sdk.weixin.XmlUtil;
